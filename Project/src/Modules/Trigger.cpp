...
{
    cout << "[TriggerModule] Init completed." << endl;
}
...
bool TriggerModule::ReadTriggerSignal()
{
    ...
    if(Lock_Fire.try_lock())
        ...
        cout << "[TriggerModule][ReadTriggerSignal] Already firing." << endl;
}
...
{
    //开始
    cout << "[InfraredEmitterThread] Fire start." << endl;
    //1.打开红外灯
//todo
    //2.等待X秒
...
//todo
    ...
    Lock_Fire.unlock();
    //结束
    cout << "[InfraredEmitterThread] Fire stop." << endl;
}